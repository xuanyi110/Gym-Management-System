module.exports = {
    ...
    getCalByMealPlan: 'SELECT mp.id, SUM(f.calories) from food_item f, food_item_in_meal_plan fm, meal_plan mp where fm.food_item = f.name and mp.id = fm.plan_id and mp.id = "{{meal_plan_ID}}" group by mp.id',
