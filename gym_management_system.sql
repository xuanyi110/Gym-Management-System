...
drop table CUSTOMER;
drop table Area;
drop table COACH_EXPERIENCE;
drop table MEAL_PLAN;
drop table FOOD_ITEM;
drop table Staff_Location;
drop table MEMBERSHIP;
drop table GYM_SESSION;
drop table COURSE_REGISTRATION;
drop table Course_in_area;
drop table machine_in_Area;
drop table MEMBERSHIP_MODIFICATION;
drop table machine_in_Area;
drop table STAFF;
drop table COACH;
drop table SALES;
...
drop table MEAL_PLAN_RECOMMENDATION;
drop table FOOD_ITEM_IN_MEAL_PLAN;
drop table JANITOR;
drop table CLEANING_RECORD;
drop table REPORT;
